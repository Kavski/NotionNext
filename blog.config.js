...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LingYun2', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱数码爱生活的UP主,望关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chat.xesims.top', // 网站地址
